...
<div class="wrapper">
    ...
    <div id="main-wrapper" class="col-sm-10">
        <div class="col-sm-8">
            <form:form cssClass="form-horizontal" modelAttribute="vehicleModel" action="/admin/vehicle/model/add" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="inputNewVehicleModel" class="col-sm-2 control-label">Model</label>
                        <div class="col-sm-10">
                            <form:input path="vehicleModelName" type="text" cssClass="form-control" id="inputNewVehicleModel" placeholder="Vehicle Model"></form:input>
                        </div>
                    </div>
                    <div class="form-group">
